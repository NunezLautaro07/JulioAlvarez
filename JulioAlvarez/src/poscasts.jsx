              ...
              <p className=" ">
                <span className="fw-bold">{post.nombre}</span>
                 <br /> {post.descripcion}
                  <br className=""/>
                  <div className="mt-1">
                  <FontAwesomeIcon icon="file-pdf" size="xl" className="margen-derecha-pdf  "   /> 
                  <FontAwesomeIcon className="mt-1 " icon={faCirclePlay} size="xl"  /> <p className="d-inline disabled small blockquote-footer" >5:40</p>
                  </div>
